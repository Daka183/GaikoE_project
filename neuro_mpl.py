...
class MPL():
    ...
    def create_model(self):
        ...
        self.model.add(Dense(512, input_shape=(self.word_count,)))
    ...
    def training_model(self):
        ...
        score = self.model.evaluate(self.x_test, self.y_test,
                       batch_size=settings.batch_size, verbose=settings.verbose)
        print()
    ...
    def predict(self, dict, tokenizer, text):
        ...
        text_vec = tokenizer.sequences_to_matrix(textSequences, mode='binary')
